...
public class ReadDBFAssert {
  ...
  public static void testReadDBFFile(DBFReader reader, int expectedColumns, int expectedRows)
      throws DBFException {
  ...
  public static void testReadDBFFile(
      File file, int expectedColumns, int expectedRows, Boolean showDeletedRows)
  ...
  public static void testReadDBFFile(InputStream is, int expectedColumns, int expectedRows)
      throws DBFException {
    testReadDBFFile(new DBFReader(is), expectedColumns, expectedRows);
  }

  public static void testReadDBFFile(String fileName, int expectedColumns, int expectedRows)
      throws DBFException, IOException {
    testReadDBFFile(fileName, expectedColumns, expectedRows, false);
  }

  public static void testReadDBFFile(
      String fileName, int expectedColumns, int expectedRows, Boolean showDeletedRows)
      throws DBFException, IOException {
    testReadDBFFile(
        new File("src/test/resources/" + fileName + ".dbf"),
        expectedColumns,
        expectedRows,
        showDeletedRows);
  }

  public static void testReadDBFFileDeletedRecords(
      String fileName, int expectedRows, int expectedDeleted) throws DBFException, IOException {
      ...
      reader =
          new DBFReader(
              new BufferedInputStream(
                  new FileInputStream(new File("src/test/resources/" + fileName + ".dbf"))),
              true);
      Object[] rowObject;
