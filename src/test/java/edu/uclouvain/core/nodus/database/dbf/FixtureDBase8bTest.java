...
import static edu.uclouvain.core.nodus.database.dbf.testutils.DateUtils.createDate;
...
public class FixtureDBase8bTest {
  ...
  public void test8b() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(DBFDataType.CHARACTER, header.fieldArray[0].getDBFType());
      ...
      Assert.assertEquals(DBFDataType.NUMERIC, header.fieldArray[1].getDBFType());
      ...
      Assert.assertEquals(DBFDataType.DATE, header.fieldArray[2].getDBFType());
      ...
      Assert.assertEquals(DBFDataType.LOGICAL, header.fieldArray[3].getDBFType());
      ...
      Assert.assertEquals(DBFDataType.FLOATING_POINT, header.fieldArray[4].getDBFType());
      ...
      Assert.assertEquals(DBFDataType.MEMO, header.fieldArray[5].getDBFType());
