...
public class DBFMemoFileTest {
  ...
  private void testMemo83(boolean inMemory) throws Exception {
    ...
    try {
      file =
          new DBFMemoFile(
              new File("src/test/resources/fixtures/dbase_83.dbt"),
  ...
  private void testMemo8b(boolean inMemory) throws Exception {
    ...
    try {
      file =
          new DBFMemoFile(
              new File("src/test/resources/fixtures/dbase_8b.dbt"),
              Charset.forName("windows-1252"),
              inMemory);
  ...
  private void testMemoBinary(boolean inMemory) throws Exception {
    ...
    try {
      ...
      file =
          new DBFMemoFile(
              new File("src/test/resources/inventory.dbt"),
              Charset.forName("windows-1252"),
              inMemory);
  ...
  private void testMemoFPT(boolean inMemory) throws Exception {
    ...
    try {
      file =
          new DBFMemoFile(
              new File("src/test/resources/fixtures/dbase_f5.fpt"),
              Charset.forName("windows-1252"),
              inMemory);
      ...
      Assert.assertEquals(
          "jos‚ vicente salvador\r\n"
              + "capell…: salvador vidal\r\n"
              + "en n‚ixer, les castellers li van fer un pilar i el van entregar al seu pare.",
          file.readData(52, DBFDataType.MEMO));
    } finally {
      DBFUtils.close(file);
    }
  }
