...
public class DBFFieldTest {
  ...
  public void testExcecsiveDecimalCount() {
    ...
    field.setDBFType(DBFDataType.NUMERIC);
    field.setLength(15);
  ...
  public void testInvalidDecimalCountForNoNumeric() {
    DBFField field = new DBFField();
    field.setDBFType(DBFDataType.CHARACTER);
    field.setLength(15);
  ...
  public void testsetLengthNotValidInDate() {
    DBFField field = new DBFField();
    field.setDBFType(DBFDataType.DATE);
    field.setLength(5);
  }
  ...
  public void testTypeNotWriteSupport() {
    DBFField field = new DBFField();
    field.setDBFType(DBFDataType.MEMO);
  }
  ...
  public void testValidFieldLength() {
    ...
    field.setDBFType(DBFDataType.NUMERIC);
    field.setLength(10);
    assertEquals(DBFDataType.NUMERIC, field.getDBFType());
