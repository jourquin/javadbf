 ...
 *
 * <p>Please note that this is the file format used by the Brazilian Ministry of Health (DATASUS),
 * and it is not related to the Microsoft FoxPro or CANdb DBC file formats. DATASUS is the name of
 * the Department of Informatics of Brazilian Health System. It is the agency resposible for
 * publishing Brazilian public healthcare data. Besides DATASUS, the Brazilian National Agency for
 * Supplementary Health (ANS) also uses this file format for its public data.
 */
public class DBCDATASUSReader extends DBFReader {

  /**
   * Create a Reader for DBC DATASUS data. charset is autodetected and deleted records are skipped
   *
  ...
  /**
   * Create a Reader for DBC DATASUS data. charset is autodetected
   *
   * @param in the InputStream where the data is read from.
  ...
  /**
   * Create a Reader for DBC DATASUS data. Deleted records are skipped
   *
   * @param in the InputStream where the data is read from.
