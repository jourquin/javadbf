 ...
 *
 * <p>It has methods to ease obtain data.
 */
public class DBFRow {
  ...
  /**
   * Check if the record is deleted. if you pass true on showDeletedRows to DBFReader constructor,
   * deleted records are retrieved and this method allows you to check if the record is valid or
   * deleted
   *
  ...
  public String getString(int columnIndex) {
    if (columnIndex < 0 || columnIndex >= data.length) {
      throw new IllegalArgumentException(
          "Invalid index field: (" + columnIndex + "). Valid range is 0 to " + (data.length - 1));
    }
  ...
  public BigDecimal getBigDecimal(int columnIndex) {
    ...
    throw new DBFException(
        "Unsupported type for BigDecimal at column:"
            + columnIndex
            + " "
  ...
  public boolean getBoolean(int columnIndex) {
    ...
    throw new DBFException(
        "Unsupported type for Boolean at column:"
            + columnIndex
            + " "
            + fieldValue.getClass().getCanonicalName());
  }
  ...
  public byte[] getBytes(int columnIndex) {
    ...
    throw new DBFException(
        "Unsupported type for byte[] at column:"
            + columnIndex
            + " "
            + fieldValue.getClass().getCanonicalName());
  }
  ...
  public Date getDate(int columnIndex) {
    ...
    throw new DBFException(
        "Unsupported type for Date at column:"
            + columnIndex
            + " "
            + fieldValue.getClass().getCanonicalName());
  }
  ...
  public double getDouble(int columnIndex) {
    ...
    throw new DBFException(
        "Unsupported type for Number at column:"
            + columnIndex
            + " "
            + fieldValue.getClass().getCanonicalName());
  }
