...
public final class Utils {
  ...
  @Deprecated public static final int ALIGN_LEFT = 10;
  /** @deprecated Use {@link DBFAlignment#RIGHT} */
  @Deprecated public static final int ALIGN_RIGHT = 12;
   ...
   * Uses spaces as padding and align data to the left
   *
  ...
  public static byte[] textPadding(
      String text, Charset charset, int length, DBFAlignment alignment) {
  ...
  @Deprecated
  public static byte[] textPadding(
      String text, Charset charset, int length, DBFAlignment alignment, byte paddingByte) {
  ...
  @Deprecated
  public static byte[] doubleFormating(
      Double doubleNum, Charset charset, int fieldLength, int sizeDecimalPart) {
   ...
   * @deprecated this functions really trim all spaces, instead only left spaces, so for clarity is
   *     deprecated and mantained for backwards compatibility, use {@link
  ...
  /**
   * Obtais the data to store in file for a text field. Text is truncated if exceed field capacity.
   * Uses spaces as padding and alignment left
   *
   * @param text the text to write
   * @param characterSetName The charset to use
   * @param length field length
  ...
  @Deprecated
  public static byte[] textPadding(
      String text, String characterSetName, int length, DBFAlignment alignment)
      throws UnsupportedEncodingException {
  ...
  @Deprecated
  public static byte[] textPadding(
      String text, String characterSetName, int length, DBFAlignment alignment, byte paddingByte)
      throws UnsupportedEncodingException {
  ...
  @Deprecated
  public static byte[] doubleFormating(
      Number num, String characterSetName, int fieldLength, int sizeDecimalPart)
      throws UnsupportedEncodingException {
  ...
  public static byte[] doubleFormating(
    ...
    return doubleFormating(
        doubleNum, Charset.forName(characterSetName), fieldLength, sizeDecimalPart);
  }
}
