...
public final class DBFUtils {
  ...
  /**
   * pad a string and convert it to byte[] to write to a dbf file (by default, add whitespaces to
  ...
  /**
   * Closes silently a #{@link java.io.Closeable}. it can be null or throws an exception, will be
   * ignored.
   *
